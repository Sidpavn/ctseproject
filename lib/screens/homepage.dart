    ...
    return Scaffold(
              ...
              return Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text('Welcome back, ${storage.getItem(('username'))}!',
                        ...
                        Text('As of date, ${storage.getItem(('currentDate'))}.',
                          style: GoogleFonts.robotoMono(
                            textStyle: Theme.of(context).textTheme.headline4,
                            ...
                            children: [
                              Flexible(
                                child: Stack(
                                  children: <Widget>[
                                    GestureDetector(
                                      onTap: () => Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: ToDoPage())),
                                      child: Column(
                                        children: [
                                          Container(
                                              alignment: Alignment.topLeft,
                                              margin: EdgeInsets.only(top: 10.h, left: 15.h, right: 15.h),
                                              child: RichText(
                                                  textAlign:TextAlign.left,
                                                  text:TextSpan(
                                                      children:[
                                                        storage.getItem(('todayTodoListCount')) == 1 ? TextSpan(text: 'Today you have,\n${storage.getItem(('todayTodoListCount'))} task to do.',
                                                          style: GoogleFonts.robotoMono(
                                                            textStyle: Theme.of(context).textTheme.headline4,
                                                            color: Colors.black,
                                                            fontSize: 18.h,
                                          ...
                                          Container(
                                              alignment: Alignment.topLeft,
                                              margin: EdgeInsets.only(top: 5.h, left: 15.h, right: 15.h),
                                              child: RichText(
                                                  textAlign:TextAlign.left,
                                                  text:TextSpan(
                                                      children:[
                                                        TextSpan( text :'Check here!',
                                                          style: GoogleFonts.robotoMono(
                                                            textStyle: Theme.of(context).textTheme.headline4,
                                                            color: Colors.black,
                                                            fontSize: 10.5.h,
                                    ...
                                    Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.all(Radius.elliptical(90.h,90.h)),
                                          ),
                                          child: IconButton(
                                            iconSize: 90.0.h,
        ...
        bottomNavigationBar: CustomNavigationBar(
            ...
            onTap: (index) {
              ...
              if(_currentIndex == 1 ){
                userDataCollection.doc('ctse_user_001').update({"position": 'todo'});
